...
export class FooterComponent implements AfterViewInit {
    ...
    public ngAfterViewInit() {
        if (this.element){
            ...
            this.element.nativeElement.querySelector(".mdc-switch__ripple").style = "display:none";
        }
    }
